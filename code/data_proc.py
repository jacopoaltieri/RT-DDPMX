...
def process_folder(input_folder, output_folder, roi_size, max_workers, process_all_frames=False):
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        for file_path in files:
            executor.submit(process_image, file_path, output_folder, roi_size, process_all_frames)
...
if __name__ == "__main__":
    ...
    process_folder(input_folder, output_folder, img_size, max_workers, process_all_frames)
